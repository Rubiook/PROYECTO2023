...
namespace PRESENTACION.PRESENTACION
{
    public partial class LotesAsignadosAlRemate : Form
    {
        ...
        private readonly LotesAsignados _negocioLotesRemates;
        ...
        public LotesAsignadosAlRemate(int remateId, DateTime fechaRemate, LotesAsignados negocioLotesRemates, DataGridView dataGridView2, GestionDeLotesYRemates gestionRematesYLotes, string proveedor)
        {
            InitializeComponent();
